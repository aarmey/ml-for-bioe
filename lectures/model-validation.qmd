---
title: Does my model work? Cross-validation, bootstrap, and friends
author: Aaron Meyer
---
...
- Randomization and hiding things are the key to success!
	- Cross-validation hides parts of the data at each step, to see how the model can predict it.
