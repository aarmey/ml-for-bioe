...
![By Rdbickel - Own work, CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=49599354](./figs/lec2/decode0.webp)
...
![Kong *et al*, *Nature*, 2012](./figs/lec2/decode1.jpg)

## Application: Paternal *de novo* mutations

![Kong *et al*, *Nature*, 2012](./figs/lec2/decode2.jpg)
...
![ ](./figs/lec2/bindingdata.png){ width=70% }
...
![ ](./figs/lec2/bindingpred.png){ width=70% }
