...
![ ](./figs/regression/garbage.svg){fig-alt="A chart showing a spurious correlation between two random measurements over time."}
...
![By Rdbickel - Own work, CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=49599354](./figs/regression/meiosis.svg){fig-alt="Schematic of cells undergoing meiosis."}
...
![Kong *et al*, *Nature*, 2012](./figs/regression/decode1.jpg){fig-alt="Figure from Kong et al showing the family tree of several sample collections."}

## Application: Paternal *de novo* mutations

![Kong *et al*, *Nature*, 2012](./figs/regression/decode2.jpg){fig-alt="Figure from Kong et al showing a significant correlation between father age and number of de novo mutations."}
...
![ ](./figs/regression/olsplot.svg){fig-alt="Plot of measured vs. predicted values of scikit-learn's diabetes dataset."}
...
![ ](./figs/regression/bindingdata.png)
...
![ ](./figs/regression/bindingpred.png)
