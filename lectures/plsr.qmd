...
- Both methods are supervised learning methods; however, they have a number of distinct properties from other methods we will discuss.
...
6. Cycle until convergence, then subtract off variance explained by $\widehat{\mathbf{X}} = \mathbf{t}_a\mathbf{p}'_a$ and $\widehat{\mathbf{Y}}_a = \mathbf{t}_a \mathbf{c}'_a$.
...
- [`sklearn.cross_decomposition.PLSRegression`](https://scikit-learn.org/stable/modules/generated/sklearn.pipeline.Pipeline.html)
	...
	- Or `M.n_components = 3` after initialization
...
- Maximizes the variance explained in the independent (X) data

## Performance

- PLSR is amazingly good at prediction
