...
![ ](./figs/hmm/gupta6.webp)

# Example 2: Sequence Prediction

![AXL prediction](./figs/hmm/AXL-THMM.svg)
...
10. [TMHMM](https://services.healthtech.dtu.dk/services/DeepTMHMM-1.0/) is a HMM model that can be used to predict the transmembrane regions of proteins (there’s an example input you can use in the guide). Show us the output. Which algorithm is being used for each part of the output graphic?
