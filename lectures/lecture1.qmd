...
3. **Central Limit Theorem**: As $n$ increases, sampling distributions of the sample mean tends towards normality. $\bar{X} \approx N\left(\mu, \frac{\sigma^2}{n}I\right)$
