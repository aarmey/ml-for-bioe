...
![Lazebnik et al, Cancer Cell, 2002](./figs/lec1/laz1.jpg)

## Why we need models - Can a biologist fix a radio?

![Lazebnik et al, Cancer Cell, 2002](./figs/lec1/laz2.jpg)

## Why we need models - Can a biologist fix a radio?

![Lazebnik et al, Cancer Cell, 2002](./figs/lec1/laz3.png)
...
![Thompson et al. Proc. 1st Int. Conf. on Evolvable Systems, 1996](./figs/lec1/fig1.png){height=3in}

## Machine learning can outperform a human for some tasks

![Thompson et al. Proc. 1st Int. Conf. on Evolvable Systems, 1996](./figs/lec1/fig2.png){height=3in}

## Machine learning can outperform a human for some tasks

![Thompson et al. Proc. 1st Int. Conf. on Evolvable Systems, 1996](./figs/lec1/fig3.png){height=3in}

## Machine learning can outperform a human for some tasks

![Thompson et al. Proc. 1st Int. Conf. on Evolvable Systems, 1996](./figs/lec1/fig4.png){height=3in}
...
![ ](./figs/lec1/normal_pdf.png){width=60%}
